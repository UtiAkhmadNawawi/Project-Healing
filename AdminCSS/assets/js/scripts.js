"use strict";
! function (p, u) {
    p.Package.name = "DashLite", p.Package.version = "2.3";
    var c = u(window),
        a = u("body"),
        l = u(document),
        t = "nk-menu",
    ...
    p.ClassBody = function () {
        ...
        u(".nk-menu-link, .menu-link, .nav-link").each(function () {
            var t = u(this),
                e = t.attr("href");
            n.match(e) ? (t.closest("li").addClass("active current-page").parents().closest("li").addClass("active current-page"), t.closest("li").children(".nk-menu-sub").css("display", "block"), t.parents().closest("li").children(".nk-menu-sub").css("display", "block"), this.scrollIntoView({
                block: "start"
        ...
        var t = u(t || ".toggle"),
            ...
            r = e ? f(a, e) : a;
        p.TGL.screen(n), t.on("click", function (t) {
            s = this, p.Toggle.trigger(u(this).data("target"), r), t.preventDefault()
        }), l.on("mouseup", function (t) {
            var e, n, a, i, o;
            s && (e = u(s), n = u(s).data("target"), n = u('[data-content="'.concat(n, '"]')), a = u(".datepicker-dropdown"), i = u(".ui-timepicker-container"), o = u(".modal"), e.is(t.target) || 0 !== e.has(t.target).length || n.is(t.target) || 0 !== n.has(t.target).length || 0 !== u(t.target).closest(".select2-container").length || a.is(t.target) || 0 !== a.has(t.target).length || i.is(t.target) || 0 !== i.has(t.target).length || o.is(t.target) || 0 !== o.has(t.target).length || (p.Toggle.removed(e.data("target"), r), s = !1))
        }), c.on("resize", function () {
            n.each(function () {
        ...
        u(t).on("click", function (t) {
            p.Toggle.trigger(u(this).data("target"), a), t.preventDefault()
        })
        ...
        var t = t || ".nk-menu-toggle",
            ...
            a = e ? f(n, e) : n;
        u(t).on("click", function (t) {
            (p.Win.width < d.lg || u(this).parents().hasClass(r)) && p.Toggle.dropMenu(u(this), a), t.preventDefault()
        })
        ...
        n.on("click", function (t) {
            p.Toggle.trigger(u(this).data("target"), o), t.preventDefault()
        }), l.on("mouseup", function (t) {
        ...
        u(t).exists() && u(t).each(function () {
            var t = {
                ...
                t = e ? f(t, e) : t;
            u(this).validate(t), p.Validate.OnChange(".js-select2"), p.Validate.OnChange(".date-picker"), p.Validate.OnChange(".js-tagify")
        })
        ...
        u(t).exists() && u(t).each(function () {
            ...
            u(this).DataTable(e), u(".dt-export-title").text(n)
        })
        ...
        u(t || '[data-toggle="modal"]').on("click", function () {
            ...
            t && "#" !== t && e ? e.find('[href="' + t + '"]').tab("show") : e && (n = e.find(".nk-nav.nav-tabs"), t = u(n[0]).find('[data-toggle="tab"]'), u(t[0]).tab("show"))
        })
    }, p.ModeSwitch = function () {
        var t = u(".dark-switch");
        a.hasClass("dark-mode") ? t.addClass("active") : t.removeClass("active"), t.on("click", function (t) {
            t.preventDefault(), u(this).toggleClass("active"), a.toggleClass("dark-mode")
        })
    }, p.Knob = function (t, e) {
        var n, a;
        u(t).exists() && "function" == typeof u.fn.knob && (n = {
            min: 0
        }, a = e ? f(n, e) : n, u(t).each(function () {
            u(this).knob(a)
        }))
        ...
        p.Knob(".knob", t), p.Knob(".knob-half", e)
        ...
        0 < t.length && t.forEach(function (t, e) {
            var n = {
                ...
                n = a ? f(n, a) : n;
            p.Custom.Stepper(t, n), p.Validate.OnChange(".js-select2"), p.Validate.OnChange(".date-picker"), p.Validate.OnChange(".js-tagify")
        })
    }, p.Stepper.init = function () {
        p.Stepper(".stepper-init")
    }, p.Tagify = function (t, e) {
        u(t).exists() && "function" == typeof u.fn.tagify && (e = e ? f(void 0, e) : void 0, u(t).tagify(e))
        ...
        p.TGL.content(".toggle"), p.TGL.expand(".toggle-expand"), p.TGL.expand(".toggle-opt", {
            toggle: !1
        }), p.TGL.showmenu(".nk-nav-toggle"), p.TGL.ddmenu("." + t + "-toggle", {
            self: t + "-toggle",
            child: t + "-sub"
        })
        ...
        p.coms.docReady.push(p.OtherInit), p.coms.docReady.push(p.Prettify), p.coms.docReady.push(p.ColorBG), p.coms.docReady.push(p.ColorTXT), p.coms.docReady.push(p.Copied), p.coms.docReady.push(p.Ani.init), p.coms.docReady.push(p.TGL.init), p.coms.docReady.push(p.BS.init), p.coms.docReady.push(p.Validate.init), p.coms.docReady.push(p.Picker.init), p.coms.docReady.push(p.Addons.Init), p.coms.docReady.push(p.Wizard), p.coms.docReady.push(p.sbCompact), p.coms.docReady.push(p.Stepper.init), p.coms.winLoad.push(p.ModeSwitch)
    }, p.init()
}(NioApp, jQuery);
