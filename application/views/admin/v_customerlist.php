                                                                            ...
                                                                            <div class="row gx-6 gy-3">
                                                                                ...
                                                                                <div class="col-6">
                                                                                    <div class="form-group">
                                                                                        <label
                                                                                            class="overline-title overline-title-alt">Package</label><select
                                                                                ...
                                                                                <div class="col-6">
                                                                                    <div class="form-group">
                                                                                        <label
                                                                                            class="overline-title overline-title-alt">Group</label><select
                                                                                            class="form-select js-select2 js-select2-sm">
                                                                                            <option value="any">
                                                                                                Any
                                                                                                Group
                            ...
                            <div class="card-inner p-0">
                                <div class="nk-tb-list nk-tb-ulist">
                                    <div class="nk-tb-item nk-tb-head">
                                        ...
                                        <div class="nk-tb-col tb-col-mb"><span class="sub-text">Last
                                                Package</span></div>
                                                        ...
                                                        <li>
                                                            <div
                                                                ...
                                                                <input type="checkbox" class="custom-control-input"
                                                                    checked="" id="gp"><label
                                                                    class="custom-control-label" for="gp">Group</label>
                                                            </div>
                                                        </li>
                                                        <li>
                                                            <div
                                                                ...
                                                                <input type="checkbox" class="custom-control-input"
                                                                    checked="" id="ph"><label
                                                                    class="custom-control-label" for="ph">Phone</label>
                                                            </div>
                                                        </li>
                                                        <li>
                                                            <div
                                                                class="custom-control custom-control-sm custom-checkbox">
                                                                <input type="checkbox" class="custom-control-input"
                                                                    id="vri"><label class="custom-control-label"
                                    ...
                                    <div class="nk-tb-item">
                                        ...
                                        <div class="nk-tb-col tb-col-mb"><span class="tb-status text-dark">Dimond</span>
                                        </div>
                                        <div class="nk-tb-col nk-tb-col-tools">
                                            <ul class="nk-tb-actions gx-1">
                                                <li class="nk-tb-action-hidden"><a href="#"
                                                        class="btn btn-trigger btn-icon" data-bs-toggle="tooltip"
                                                        data-bs-placement="top" title="Send Email"><em
                                                    ...
                                                    <div class="drodown"><a href="#"
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-end">
                                                            <ul class="link-list-opt no-bdr">
                                                                ...
                                                                <li class="divider"></li>
                                                                <li><a data-bs-toggle="modal" href="#edit-customer"><em
                                    ...
                                    <div class="nk-tb-item">
                                        ...
                                        <div class="nk-tb-col tb-col-mb"><span
                                                class="tb-status text-primary">Silver</span></div>
                                        <div class="nk-tb-col nk-tb-col-tools">
                                            <ul class="nk-tb-actions gx-1">
                                                <li class="nk-tb-action-hidden"><a href="#"
                                                        class="btn btn-trigger btn-icon" data-bs-toggle="tooltip"
                                    ...
                                    <div class="nk-tb-item">
                                        ...
                                        <div class="nk-tb-col tb-col-md"><span>+811 569-6523</span>
                                        </div>
                                        <div class="nk-tb-col tb-col-lg">
                                            <ul class="list-status">
                                                <li><em class="icon text-success ni ni-check-circle"></em>
                                        ...
                                        <div class="nk-tb-col tb-col-mb"><span
                                                class="tb-status text-orange">Platinum</span></div>
                                        <div class="nk-tb-col nk-tb-col-tools">
                                            <ul class="nk-tb-actions gx-1">
                                                <li class="nk-tb-action-hidden"><a href="#"
                                                        class="btn btn-trigger btn-icon" data-bs-toggle="tooltip"
                                    ...
                                    <div class="nk-tb-item">
                                        ...
                                        <div class="nk-tb-col tb-col-lg"><span>07 Feb 2021</span></div>
                                        <div class="nk-tb-col tb-col-mb"><span
                                                class="tb-status text-warning">Gold</span></div>
                                        <div class="nk-tb-col nk-tb-col-tools">
                                            <ul class="nk-tb-actions gx-1">
                                                <li class="nk-tb-action-hidden"><a href="#"
                                                        class="btn btn-trigger btn-icon" data-bs-toggle="tooltip"
                                    ...
                                    <div class="nk-tb-item">
                                        ...
                                        <div class="nk-tb-col tb-col-mb"><span class="tb-status text-grey">Basic</span>
                                        </div>
                                        <div class="nk-tb-col nk-tb-col-tools">
                                            <ul class="nk-tb-actions gx-1">
                                                <li class="nk-tb-action-hidden"><a href="#"
                                    ...
                                    <div class="nk-tb-item">
                                        ...
                                        <div class="nk-tb-col tb-col-mb"><span>Vacation</span></div>
                                        <div class="nk-tb-col tb-col-md"><span>+124 156-8756</span>
                                        </div>
                                        <div class="nk-tb-col tb-col-lg">
                                            <ul class="list-status">
                                                <li><em class="icon text-success ni ni-check-circle"></em>
                                    ...
                                    <div class="nk-tb-item">
                                        ...
                                        <div class="nk-tb-col tb-col-mb"><span>Continental</span></div>
                                        <div class="nk-tb-col tb-col-md"><span>+811 963-4759</span>
                                        </div>
                                        <div class="nk-tb-col tb-col-lg">
                                            <ul class="list-status">
                                                <li><em class="icon text-success ni ni-check-circle"></em>
                    ...
                    <div class="row g-gs">
                        ...
                        <div class="col-md-6">
                            <div class="form-group"><label class="form-label" for="phone-no">Phone
                                    Number</label><input type="text" class="form-control" id="phone-no" value="+880"
                                    placeholder="Phone Number"></div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group"><label class="form-label" for="address">Address</label><input
                                    type="text" class="form-control" id="address" value="2337 Kildeer Drive"></div>
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <div class="form-group"><label class="form-label" for="group">Group</label><select
                                    class="form-select js-select2" id="group">
