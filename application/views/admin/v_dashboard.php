                                ...
                                <div class="card-inner-group">
                                    <div class="card-inner">
                                        <div class="card-title-group">
                                            ...
                                            <div class="card-tools"><a href="/demo1/hotel/customers.html"
                                                    class="link">View
                                                    All</a></div>
                                        </div>
                                    </div>
                                ...
                                <ul class="nk-activity">
                                    <li class="nk-activity-item">
                                        <div class="nk-activity-media user-avatar bg-success"><img
                                                src="/demo1/images/avatar/c-sm.jpg" alt=""></div>
                                    ...
                                    <li class="nk-activity-item">
                                        <div class="nk-activity-media user-avatar bg-purple"><img
                                                src="/demo1/images/avatar/d-sm.jpg" alt=""></div>
                                        <div class="nk-activity-data">
