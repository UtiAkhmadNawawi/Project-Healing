        ...
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-center"
            ...
            <div class="col-md-9 ftco-animate text-center" data-scrollax=" properties: { translateY: '70%' }">
                <p class="breadcrumbs" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }"><span
                        class="mr-2"><a href="http://localhost/project-Healing/">Home</a></span> <span class="mr-2"><a
                            href="http://localhost/project-Healing/Hotel/index">Hotel</a></span> <span>Hotel
                        Single</span></p>
                ...
                <div class="row">
                    <div class="col-md-12 ftco-animate">
                        <div class="single-slider owl-carousel">
                            <div class="item">
                                <div class="hotel-img"
                                    style="background-image: url(<?php echo base_url() ?>images/hotel-2.jpg);"></div>
                            </div>
                            <div class="item">
                                <div class="hotel-img"
                                    style="background-image: url(<?php echo base_url() ?>images/hotel-3.jpg);"></div>
                            </div>
                            <div class="item">
                                <div class="hotel-img"
                                    style="background-image: url(<?php echo base_url() ?>images/hotel-4.jpg);"></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12 hotel-single ftco-animate mb-5 mt-4">
                        ...
                        <div class="block-16">
                            <figure>
                                <img src="<?php echo base_url() ?>images/hotel-6.jpg" alt="Image placeholder"
                                    class="img-fluid">
                    ...
                    <div class="col-md-12 hotel-single ftco-animate mb-5 mt-4">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="destination">
                                    <a href="hotel-single.html" class="img img-2"
                                        style="background-image: url(<?php echo base_url() ?>images/room-4.jpg);"></a>
                                    <div class="text p-3">
                                        <div class="d-flex">
                                            <div class="one">
                            ...
                            <div class="col-md-4">
                                <div class="destination">
                                    <a href="hotel-single.html" class="img img-2"
                                        style="background-image: url(<?php echo base_url() ?>images/room-5.jpg);"></a>
                                    <div class="text p-3">
                                        <div class="d-flex">
                                            <div class="one">
                                                <h3><a href="hotel-single.html">Hotel, Italy</a></h3>
                            ...
                            <div class="col-md-4">
                                <div class="destination">
                                    <a href="hotel-single.html" class="img img-2"
                                        style="background-image: url(<?php echo base_url() ?>images/room-6.jpg);"></a>
                                    <div class="text p-3">
                                        <div class="d-flex">
                                            <div class="one">
                                                <h3><a href="hotel-single.html">Hotel, Italy</a></h3>
                    ...
                    <div class="col-md-12 hotel-single ftco-animate mb-5 mt-5">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="destination">
                                    <a href="hotel-single.html" class="img img-2"
                                        style="background-image: url(<?php echo base_url() ?>images/hotel-1.jpg);"></a>
                                    <div class="text p-3">
                                        <div class="d-flex">
                                            <div class="one">
                                                <h3><a href="hotel-single.html">Hotel, Italy</a></h3>
                            ...
                            <div class="col-md-4">
                                <div class="destination">
                                    <a href="hotel-single.html" class="img img-2"
                                        style="background-image: url(<?php echo base_url() ?>images/hotel-2.jpg);"></a>
                                    <div class="text p-3">
                                        <div class="d-flex">
                                            <div class="one">
                                                <h3><a href="hotel-single.html">Hotel, Italy</a></h3>
                            ...
                            <div class="col-md-4">
                                <div class="destination">
                                    <a href="hotel-single.html" class="img img-2"
                                        style="background-image: url(<?php echo base_url() ?>images/hotel-3.jpg);"></a>
                                    <div class="text p-3">
                                        <div class="d-flex">
                                            <div class="one">
                                                <h3><a href="hotel-single.html">Hotel, Italy</a></h3>
